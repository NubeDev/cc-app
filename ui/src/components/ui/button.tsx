...
// shadcn/ui Button, tuned for the modern-iOS design language: continuous
// rounded corners (--radius), ≥44px touch targets on the default size, quick
// ease-out feedback. Semantic tokens only.
