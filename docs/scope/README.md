...
| [`billing/billing-scope.md`](billing/billing-scope.md) | Phase 2: households, invoices, provider-behind-a-trait; phase-1 must-not-preclude notes | this repo (own extension `care-billing`) |
